...
button = document.querySelector('.up-button'), // upload button
form = document.querySelector('.photo-form'), // form ( drag area )
container = document.querySelector('.blank-container'), // container in which image will be insert
